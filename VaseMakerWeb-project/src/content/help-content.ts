  ...
  // ─── 4. Textures ──────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'keyvalue', items: [
        ...
        { key: 'SVG Size X / Y', value: 'Motif size as % of tile cell. 100% = seamless tiling. Below 100% = gaps between motifs. Above 100% = motif overflows/crops. Reset button sets both to 100%' },
        ...
        { key: 'Vert Move', value: 'Shift all rows up the vase (% of vase height). Rows that go off the top disappear' },
