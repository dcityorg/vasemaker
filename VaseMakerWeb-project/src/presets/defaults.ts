...
export const DEFAULT_PARAMETERS: VaseParameters = {
  ...
  textures: {
    ...
    svgPattern: { enabled: false, svgText: '', repeatX: 4, repeatY: 6, depth: 1.0, invert: false, cutout: false, rotation: 0, flipX: false, flipY: false, sizeAround: 100, sizeUp: 100, shiftUp: 0, spaceUp: 0, stagger: 0, tileRotation: 0, randomRotation: 0, randomScale: 0, randomRotateSeed: 0, randomScaleSeed: 0, mirrorAlternate: false },
