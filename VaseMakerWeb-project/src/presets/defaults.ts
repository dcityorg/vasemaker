...
function defaultShapeParams(): Record<ShapeType, ShapeParams> {
  return {
    ...
    Astroid1:      { scaleFactor: 1,    offsetX: 0,   offsetY: 0, power: 0.667 },
    Folium1:       { scaleFactor: 1,    offsetX: 0,   offsetY: 0 },
    Gear1:         { scaleFactor: 1,    offsetX: 0,   offsetY: 0, teeth: 8, depth: 0.3, steepness: 4 },
    Limacon1:      { scaleFactor: 1,    offsetX: 0,   offsetY: 0, a: 1.5, b: 1 },
