...
function defaultShapeParams(): Record<ShapeType, ShapeParams> {
  return {
    Butterfly1:    { scaleFactor: 0.65, offsetX: 0,   offsetY: 0 },
    Cardioid1:     { scaleFactor: 0.475, offsetX: 0,   offsetY: 17 },
    ...
    Egg1:          { scaleFactor: 0.475, offsetX: 0,   offsetY: -30, width: 2.5 },
    Egg2:          { scaleFactor: 0.221, offsetX: 0,   offsetY: 0, a: 0.9, b: 2.4 },
    Ellipse1:      { scaleFactor: 1,    offsetX: 0,   offsetY: 0, scaleX: 0.6, scaleY: 1.2 },
    Heart1:        { scaleFactor: 0.95, offsetX: -12, offsetY: 0 },
    Infinity1:     { scaleFactor: 1,    offsetX: 0,   offsetY: 0, parameter1: 1.02 },
    Piriform1:     { scaleFactor: 0.317, offsetX: 0,   offsetY: 0, a: 3, b: 1 },
    ...
    Astroid1:      { scaleFactor: 0.475, offsetX: 0,   offsetY: 0, power: 0.667 },
    Folium1:       { scaleFactor: 1,    offsetX: 0,   offsetY: 0 },
    Gear1:         { scaleFactor: 0.77, offsetX: 0,   offsetY: 0, teeth: 8, depth: 0.3, steepness: 4 },
    Limacon1:      { scaleFactor: 0.95, offsetX: -33, offsetY: 0, a: 1.5, b: 1 },
...
function defaultTopShapeParams(): Record<ShapeType, ShapeParams> {
  return {
    Butterfly1:    { scaleFactor: 0.65, offsetX: 0, offsetY: 0 },
    Cardioid1:     { scaleFactor: 0.475, offsetX: 0, offsetY: 0 },
    Cardioid2:     { scaleFactor: 0.211, offsetX: 0, offsetY: 0 },
    Cardioid3:     { scaleFactor: 0.3,  offsetX: 0, offsetY: 0 },
    Circle1:       { scaleFactor: 1,    offsetX: 0, offsetY: 0 },
    Diamond1:      { scaleFactor: 1,    offsetX: 0, offsetY: 0, scaleX: 1, scaleY: 1 },
    Egg1:          { scaleFactor: 0.475, offsetX: 0, offsetY: 0, width: 2.5 },
    Egg2:          { scaleFactor: 0.221, offsetX: 0, offsetY: 0, a: 0.9, b: 2.4 },
    Ellipse1:      { scaleFactor: 1,    offsetX: 0, offsetY: 0, scaleX: 0.6, scaleY: 1.2 },
    Heart1:        { scaleFactor: 0.95, offsetX: 0, offsetY: 0 },
    Infinity1:     { scaleFactor: 1,    offsetX: 0, offsetY: 0, parameter1: 1.02 },
    Piriform1:     { scaleFactor: 0.317, offsetX: 0, offsetY: 0, a: 3, b: 1 },
    Polygon1:      { scaleFactor: 1,    offsetX: 0, offsetY: 0, sides: 5 },
    Rectangle1:    { scaleFactor: 1,    offsetX: 0, offsetY: 0, scaleX: 1, scaleY: 1.5, rounding: 0 },
...
export const DEFAULT_PARAMETERS: VaseParameters = {
  ...
  textures: {
    ...
    svgPattern: { enabled: false, svgText: '', repeatX: 4, repeatY: 6, depth: 1.0, invert: false, raised: false, cutout: false, rotation: 0, flipX: false, flipY: false, sizeAround: 100, sizeUp: 100, shiftUp: 0, shiftAround: 0, spaceUp: 0, stagger: 0, tileRotation: 0, randomRotation: 0, randomScale: 0, randomRotateSeed: 0, randomScaleSeed: 0, mirrorAlternate: false, padding: 0 },
