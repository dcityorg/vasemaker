  ...
  // ─── 4. Textures ──────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'keyvalue', items: [
        ...
        { key: 'SVG Size X / Y', value: 'Motif size as % of tile cell. 100% = seamless tiling. Below 100% = gaps between motifs with smooth fade edges. Above 100% = motif stretches beyond the cell (useful with Vert Move to extend coverage). Reset button sets both to 100%' },
