...
- **Resolution sliders** — Resolution section at bottom of sidebar with Vertical (8–200, default 60) and Radial (8–360, default 120) sliders. Unified single resolution for both preview and export (what you see is what you get). Low values create intentional faceted looks. Green dot when non-default. Defaults and ranges in `RESOLUTION` export in shape-params.ts.
